...
export async function getSelectedXmlOrDocument(editor: vscode.TextEditor): Promise<string | undefined> {
...
export function isFileSizeWithinLimit(document: vscode.TextDocument, maxBytes = 10 * 1024 * 1024): boolean {
